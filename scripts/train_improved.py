"""Улучшенный скрипт обучения мультимодального классификатора.
...
Основные отличия от ml_models/train_bert.py:
    ...
    8. Multi-seed: N запусков, mean ± std от финальной метрики — цифра, которую
       не стыдно произнести на защите.
